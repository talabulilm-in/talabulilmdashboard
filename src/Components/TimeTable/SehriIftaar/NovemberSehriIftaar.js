...
const NovemberSehriIftaar = () => {
  ...
  const getTime = async () =>{
      try {
        const response = await axios.get('https://talabulilm.in/getData.php?slimit=177&elimit=206')
    ...
    <div className='contain'>
       <div className="page-header">
          ...
          <div className="page-header__content">
            <h2 className="pagetitle">November Sehri & IFtaar</h2>
...
export default NovemberSehriIftaar;