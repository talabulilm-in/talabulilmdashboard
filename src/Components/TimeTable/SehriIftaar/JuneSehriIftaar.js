...
const JuneSehriIftaar = () => {
  ...
  const getTime = async () =>{
      try {
        const response = await axios.get('https://talabulilm.in/getData.php?slimit=54&elimit=84')
    ...
    <div className='contain'>
       <div className="page-header">
          ...
          <div className="page-header__content">
            <h2 className="pagetitle">June Sehri & IFtaar</h2>
...
export default JuneSehriIftaar;