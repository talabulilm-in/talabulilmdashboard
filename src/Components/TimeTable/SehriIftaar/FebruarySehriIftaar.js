...
const FebruarySehriIftaar = () => {
  ...
  const getTime = async () =>{
      try {
        const response = await axios.get('https://talabulilm.in/getData.php?slimit=300&elimit=328')
    ...
    <div className='contain'>
       <div className="page-header">
          ...
          <div className="page-header__content">
            <h2 className="pagetitle">February Sehri & IFtaar</h2>
...
export default FebruarySehriIftaar;