...
const MaySehriIftaar = () => {
  ...
  const getTime = async () =>{
      try {
        const response = await axios.get('https://talabulilm.in/getData.php?slimit=23&elimit=53')
    ...
    <div className='contain'>
       <div className="page-header">
          ...
          <div className="page-header__content">
            <h2 className="pagetitle">May Sehri & IFtaar</h2>
