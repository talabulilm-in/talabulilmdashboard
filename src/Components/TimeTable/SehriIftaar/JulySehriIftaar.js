...
const JulySehriIftaar = () => {
  ...
  const getTime = async () =>{
      try {
        const response = await axios.get('https://talabulilm.in/getData.php?slimit=84&elimit=114')
    ...
    <div className='contain'>
       <div className="page-header">
          ...
          <div className="page-header__content">
            <h2 className="pagetitle">July Sehri & IFtaar</h2>
...
export default JulySehriIftaar;